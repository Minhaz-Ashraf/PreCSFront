...
import LocationSelect from "../../components/CustomInput.jsx";
...
const AdvanceSearch = ({ page }) => {
  ...
  const handleInput = (fieldName, values) => {
    if (values.includes("Open to all")) {
      // If "Open to all" is selected, set all options to the state except "Open to all"
  ...
  return (
    <>
      ...
      <div className="bg-[#FCFCFC]  px-9 py-12 rounded-xl shadow  md:mx-52 mx-6 mb-36">
        ...
        {/* <LocationSelect
          ...
          stateOptions={state}
          cityOptions={city}
          countryLabel="Presently Settled in"
          stateLabel="State"
          cityLabel="City"
          customCountryName="country"
          customStateName="state"
          customCtiyName="city"
          currentlyLivingInCountry={basicSearch.country}
          currentlyLivingInState={basicSearch.state}
          currentlyLivingInCity={basicSearch.city}
        ...
        <div className="mt-6">
          ...
          <div className="mt-3">
            <Autocomplete
              ...
              value={
                country.find(
                  (option) => option.countryId === basicSearch.country
                ) || null
              }
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  label="Family Settled"
                  InputLabelProps={{
                    shrink:
                      isFocused ||
                      (basicSearch.country && basicSearch.country.length > 0),
                  }}
                  onFocus={handleFocus}
                  onBlur={handleBlur}
                  sx={{
        ...
        <div className="mt-6">
          <Autocomplete
            ...
            options={state}
            value={
              state.find((option) => option.stateId === basicSearch.state) ||
              null
            }
            ...
            renderInput={(params) => (
              <TextField
                ...
                InputLabelProps={{
                  shrink:
                    isFocused ||
                    (basicSearch.state && basicSearch.state.length > 0),
                }}
                onFocus={handleFocus}
                onBlur={handleBlur}
                sx={{
            ...
            <span className="flex flex-col justify-start items-start ">
              <span className="flex flex-row items-center" key="selectAll">
                <input
                  ...
                  onChange={(e) =>
                    handleSelectAllChange(e, "workingpreference")
                  }
                />
                <label htmlFor="selectAll" className="px-3 font-DMsans">
                  Select All
            ...
            {workingpreferenceData.map((option, index) => (
              <span className="flex flex-row items-center" key={index}>
                <input
                  ...
                  checked={basicSearch?.workingpreference?.includes(option)}
                  value={option}
                  onChange={(e) =>
        ...
        {/* <div className=" mb-2 mt-5">
          ...
          <CustomSlider
            getAriaLabel={() => "Minimum distance shift"}
            value={[
              basicSearch.annualIncomeRangeStart,
              basicSearch.annualIncomeRangeEnd,
            ]}
        ...
        value={community.find(
          (option) => option.communityId === basicSearch.community
        )}
